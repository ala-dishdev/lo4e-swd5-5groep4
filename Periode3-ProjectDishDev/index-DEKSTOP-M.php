    ...
    <main>
        <section class="hero">
            <article class="hero-content">
                ...
                <a href="reserveren.html"><button>Reserveren</button></a>
            </article>
            <article class="hero-foto">
                <img src="/images/bio-food-banner-template-with-photo 2.png" alt="foto van een gerecht">
            </article>
        </section>
    </main>
    <footer>
