...
<head>
    ...
    <script src="JS/lunch&diner.js" defer></script>
    </head>
<body>
    <header>
    ...
    <main class="main-menu">
        <section class="menu">
            ...
            <article class="menu-category">
                ...
                <article class="menu-items">
                    <article class="menu-item">
                        <img src="https://maxima.com/img/CTMXefYLMis1a1Rr3viEgRzl32RIeZ-ugvWBpzKIe5U/resize:fit:0:0/aHR0cHM6Ly9tYXhpbWEuY29tL21lZGlhL21hZ2VmYW5fYmxvZy9EZXBvc2l0cGhvdG9zXzIyMDA3MjkxNF9TLmpwZw.jpg" alt="Romige Pompoensoep" >
                        <h4>Romige Pompensoep</h4>
                        <p>Heerlijke pompoensoep met kruiden en room.</p>
                        <p>Bevat: gluten, melk</p>
                        <button class="price">€7,50</button>
                    </article>
                    <article class="menu-item">
                        <img src="https://kriskookt.be/wp-content/uploads/2023/03/Gefrituurde-artisjok-4a-1020x600.jpg" alt="Gefrituurde Arisjok">
                    ...
                    <article class="menu-item">
                        <img src="https://madanddelicacy.com/wp-content/uploads/2022/06/tris-bruschetta.jpg?w=1400" alt="Bruschetta Tricolore">
                        <h4>Bruschetta Tricolore</h4>
                        <p>Gegarneerd met pesto, gemarineerde tomaten en zachte stracchino-kaas.</p>
                        <p>Bevat: noten, gluten</p>
            ...
            <article class="menu-category">
                ...
                <article class="menu-items">
                    <article class="menu-item">
                        <img src="https://cdn.hofweb.nl/media/13241/c/Hofweb-Ministirie-web-05-portobello-wellington-large.jpg" alt="Portabello Wellington" >
                        <h4>Portobello Wellington</h4>
                        <p>Een klassieker met een plantaardig twist.</p>
                        <p>Bevat: mosterd, melk, noten, soja</p>
                        <button class="price">€19,50</button>
                    </article>
                    <article class="menu-item">
                        <img src="https://cdn.prod.website-files.com/5e51406f33d368324930f3ae/603899550f8ced61ed5d707f_Jackfruit-Rendang-Loaded-Fries.jpg" alt="Jackfruit Rendang">
                        <h4>Jackfruit Rendang</h4>
                        <p>Rijke, kruidige rendang van jackfruit</p>
                        <p>Bevat: soja, noten</p>
                        <button class="price">€18,50</button>
                    </article>
                    <article class="menu-item">
                        <img src="https://pataro.it/wp-content/uploads/2021/10/gnocchi-ripieni-tartufo-come-condirli-1200x703.jpg" alt="Gnochhi al Tartufo">
                        <h4>Gnochhi al Tartufo</h4>
                        <p>De lichtste, luchtigste gnocchi in een decadente truffelsaus</p>
                        <p>Bevat: soja, melk, noten</p>
                        <button class="price">€17,50</button>
                    </article>
                    <article class="menu-item">
                        <img src="https://eatsparkcity.org/wp-content/uploads/2021/03/vegan-burger-deluxe-300x200.jpg" alt="Beyond Burger">
                        <h4>Beyond Burger</h4>
                        <p>Heerlijke 100% plantaardige burger</p>
                        <p>Bevat: gluten, soja, mosterd</p>
            ...
            <article class="menu-category">
                ...
                <article class="menu-items">
                    <article class="menu-item">
                        <img src="https://3f4c2184e060ce99111b-f8c0985c8cb63a71df5cb7fd729edcab.ssl.cf2.rackcdn.com/media/11128/lavacake.jpg" alt="Chocolade Lava Cake" >
                        <h4>Chocolade Lava Cake</h4>
                        <p>Rijke chocoladecake met een zachte kern.</p>
                        <p>Bevat: melk, gluten</p>
                        <button class="price">€8,50</button>
                    </article>
                    <article class="menu-item">
                        <img src="https://www.allrecipes.com/thmb/g3iZQfBe4-4S-LQBuw8mafQN_tI=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/8419-easy-sour-cream-cheesecake-DDMFS-beauty-4x3-BG-2747-44b427d330aa41aa876269b1249698a0.jpg" alt="Cheesecake van de Dag">
                    ...
                    <article class="menu-item">
                        <img src="https://www.allrecipes.com/thmb/AXUJlrBCAI1P4FYPMsuzQ6DHoUg=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/AR-228515-simple-creme-brulee-dessert-dmfs-4x3-821623e7a86548eeb89370ac23d5f251.jpg" alt="Crème Brûlée">
                        <h4>Crème Brûlée</h4>
            ...
            <article class="menu-category">
                ...
                <article class="menu-items">
                    <article class="menu-item">
                        <img src="https://makkelijkafvallen.nl/wp-content/uploads/1024x800-zoete-aardappel-friet-1-3-596x380.jpg" alt="Zoete Aardappelfriet" >
                        <h4>Zoete Aardappelfriet</h4>
                        <p>Geniet van onze zoete frietjes.</p>
                        <p>Bevat: soja, gluten</p>
                        <button class="price">€4,50</button>
                    </article>
                    <article class="menu-item">
                        <img src="https://www.landleven.nl/app/uploads/2017/02/gemengde-salade-min-820x461-c-center.jpg" alt="Gemengde Salade">
                    ...
                    <article class="menu-item">
                        <img src="https://www.groentenabonnement.nl/wp-content/uploads/2020/10/geroosterde-groenten-1080x675.jpg" alt="Geroosterde Seizoensgroenten">
            ...
            <article class="menu-category">
                ...
                <article class="menu-items">
                    <article class="menu-item">
                        <img src="https://livingthegreenlife.com/wp-content/uploads/2021/11/3-warme-dranken-voor-koude-dagen.jpg" alt="Warme Dranken" >
                        <h4>Warme Dranken</h4>
                        <p>Espresso</p>
                    ...
                    <article class="menu-item">
                        <img src="https://cdn.webshopapp.com/shops/110638/files/287449980/image.jpg" alt="Koude Dranken" >
                        <h4>Koude Dranken</h4>
                    ...
                    <article class="menu-item">
                        <img src="https://spiegelau.nl/wp-content/uploads/De-perfecte-temperatuur-voor-witte-wijn.jpg" alt="Witte Wijn">
                        <h4>Witte Wijnen</h4>
                    ...
                    <article class="menu-item">
                        <img src="https://cdn.webshopapp.com/shops/320392/files/446122121/340x999x3/wat-zijn-nou-koude-rode-wijnen.jpg" alt="Rode Wijnen" >
                        <h4>Rode Wijnen</h4>
